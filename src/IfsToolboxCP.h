#ifndef _IFSTOOLBOXCP_H_
#define _IFSTOOLBOXCP_H_
...
template <class T>
class CProxyIToolboxEvents : public IConnectionPointImpl<T, &DIID_IToolboxEvents, CComDynamicUnkArray>
{
	//Warning this class may be recreated by the wizard.
public:
	HRESULT Fire_TabAdded(INT TabID, BSTR bstrTabName)
	{
	...
	HRESULT Fire_TabRemoved(INT TabID, BSTR bstrTabName)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_TabActivated(INT TabID, BSTR bstrTabName)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_ItemRemoved(INT ID, BSTR Name)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_ItemAdded(INT ID, BSTR Name)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_ItemSelected(INT ID, IToolBoxItem * pItem)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_ItemHidden(INT ID, BSTR Name)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_TabNameChanged(INT ID, BSTR Name)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_TabListViewChanged(INT ID, BSTR Name, VARIANT_BOOL ListView)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_CustomizeClicked(INT TabID, BSTR TabName)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
	...
	HRESULT Fire_TabHidden(INT ID, BSTR Name, VARIANT_BOOL Hidden)
	{
		CComVariant varResult;
		T* pT = static_cast<T*>(this);
		int nConnectionIndex;
