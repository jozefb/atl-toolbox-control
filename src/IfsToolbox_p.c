...
/* Object interface: IToolbox, ver. 0.0,
   GUID={0x4A5854D2,0xEEC7,0x415F,{0xB7,0xC9,0xC2,0x0F,0xB1,0xA8,0x99,0xE2}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IToolbox_ServerInfo;
...
static const unsigned short IToolbox_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO IToolbox_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IToolbox_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IToolbox_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IToolbox_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(19) _IToolboxProxyVtbl = 
{
    &IToolbox_ProxyInfo,
    &IID_IToolbox,
    ...
    (void *)-1 /* IToolbox::put_BackColor */ ,
    (void *)-1 /* IToolbox::get_BackColor */ ,
    (void *)-1 /* IToolbox::put_BorderColor */ ,
    (void *)-1 /* IToolbox::get_BorderColor */ ,
    (void *)-1 /* IToolbox::putref_Font */ ,
    (void *)-1 /* IToolbox::put_Font */ ,
    (void *)-1 /* IToolbox::get_Font */ ,
    (void *)-1 /* IToolbox::put_Enabled */ ,
    (void *)-1 /* IToolbox::get_Enabled */ ,
    (void *)-1 /* IToolbox::get_Window */ ,
    (void *)-1 /* IToolbox::put_TabStop */ ,
    (void *)-1 /* IToolbox::get_TabStop */
};


static const PRPC_STUB_FUNCTION IToolbox_table[] =
{
...
CInterfaceStubVtbl _IToolboxStubVtbl =
{
    &IID_IToolbox,
    &IToolbox_ServerInfo,
    19,
...
const CInterfaceProxyVtbl * _IfsToolbox_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IToolboxProxyVtbl,
    0
};

const CInterfaceStubVtbl * _IfsToolbox_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IToolboxStubVtbl,
    0
};

PCInterfaceName const _IfsToolbox_InterfaceNamesList[] = 
{
    "IToolbox",
    0
};

const IID *  _IfsToolbox_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _IfsToolbox_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _IfsToolbox, pIID, n)

int __stdcall _IfsToolbox_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_IfsToolbox_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo IfsToolbox_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _IfsToolbox_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _IfsToolbox_StubVtblList,
    (const PCInterfaceName * ) & _IfsToolbox_InterfaceNamesList,
    (const IID ** ) & _IfsToolbox_BaseIIDList,
    & _IfsToolbox_IID_Lookup, 
    1,
    2,
